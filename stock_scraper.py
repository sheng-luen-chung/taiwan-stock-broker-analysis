...
from broker_scraper_core import download_csv_text, log_broker_summary, save_processed_csv, save_raw_csv
...
class StockScraper:
    ...
    def download_stock_data(self, stock_code, max_retries=5):
        ...
        self.log(f"處理後資料已儲存為: {processed_filename}")
    ...
    def _solve_captcha(self, image_bytes):
        ...
        self.log(f"OCR 識別結果: {captcha_code}")
        return captcha_code
